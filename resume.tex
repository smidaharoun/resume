...
\address{Residence Mariem, Building N°2, Apt N°7, El Mourouj 3, 2074, Ben Arous}

\mobile{(+216) 22-230-310}
\email{smida.haroun@gmail.com}
\github{smidaharoun}
\linkedin{harounsmida}
\stackoverflow{5189517/haroun-smida}{haroun-smida}
% \gitlab{gitlab-id}
% \twitter{@twit}
% \skype{skype-id}
% \reddit{reddit-id}
